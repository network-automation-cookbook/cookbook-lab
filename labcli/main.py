...
def containerlab_deploy(
    ...
    [u]Example:[/u]
        [i]labcli containerlab deploy --topology ./containerlab/lab.yml[/i]
    """
...
def containerlab_destroy(
    ...
    [u]Example:[/u]
        [i]labcli containerlab destroy --topology ./containerlab/lab.yml[/i]
    """
    console.log("Deploying containerlab topology", style="info")
    console.log(f"Topology file: [orange1 i]{topology}", style="info")
...
def containerlab_inspect(
    ...
    [u]Example:[/u]
        [i]labcli containerlab show --topology ./containerlab/lab.yml[/i]
    """
...
def docker_build(
    ...
    To build all services:
        [i]labcli docker build --scenario batteries-included[/i]

    To build a specific services:
        [i]labcli docker build telegraf-01 telegraf-02 --scenario batteries-included[/i]
    """
...
def docker_exec(
    ...
    To execute a command in a service:
        [i]labcli docker exec telegraf-01 --scenario batteries-included --command bash[/i]

        To execute a command in a service and verbose mode:
        [i]labcli docker exec telegraf-01 --scenario batteries-included --command bash --verbose[/i]
    """
...
def docker_debug(
    ...
    To start all services in debug mode:
        [i]labcli docker debug --scenario batteries-included[/i]

    To start a specific service in debug mode:
        [i]labcli docker debug telegraf-01 --scenario batteries-included[/i]
    """
...
def docker_start(
    ...
    To start all services:
        [i]labcli docker start --scenario batteries-included[/i]

    To start a specific service:
        [i]labcli docker start telegraf-01 --scenario batteries-included[/i]
    """
...
def docker_stop(
    ...
    To stop all services:
        [i]labcli docker stop --scenario batteries-included[/i]

    To stop a specific service:
        [i]labcli docker stop telegraf-01 telegraf-02 --scenario batteries-included[/i]
    """
...
def docker_restart(
    ...
    To restart all services:
        [i]labcli docker restart --scenario batteries-included[/i]

    To restart a specific service:
        [i]labcli docker restart telegraf-01 logstash --scenario batteries-included[/i]
    """
...
def docker_logs(
    ...
    To show logs for all services:
        [i]labcli docker logs --scenario batteries-included[/i]

    To show logs for a specific service:
        [i]labcli docker logs telegraf-01 --scenario batteries-included[/i]

    To show logs for a specific service and follow the logs and tail 10 lines:
        [i]labcli docker logs telegraf-01 --scenario batteries-included --follow --tail 10[/i]
    """
...
def docker_ps(
    ...
    To show all services:
        [i]labcli docker ps --scenario batteries-included[/i]

    To show a specific service:
        [i]labcli docker ps telegraf-01 --scenario batteries-included[/i]
    """
...
def docker_destroy(
    ...
    To destroy all services:
        [i]labcli docker destroy --scenario batteries-included[/i]

    To destroy a specific service:
        [i]labcli docker destroy --scenario batteries-included[/i]

    To destroy a specific service and remove volumes:
        [i]labcli docker destroy telegraf-01 --volumes --scenario batteries-included[/i]

    To destroy all services and remove volumes:
        [i]labcli docker destroy --volumes --scenario batteries-included[/i]
    """
...
def docker_rm(
    ...
    To remove all services:
        [i]labcli docker rm --scenario batteries-included[/i]

    To remove a specific service:
        [i]labcli docker rm telegraf-01 --scenario batteries-included[/i]

    To remove a specific service and remove volumes:
        [i]labcli docker rm telegraf-01 --volumes --scenario batteries-included[/i]

    To remove all services and remove volumes:
        [i]labcli docker rm --volumes --scenario batteries-included[/i]

    To remove all services and force removal of containers:
        [i]labcli docker rm --force --scenario batteries-included[/i]

    To force removal of a specific service and remove volumes:
        [i]labcli docker rm telegraf-01 --volumes --force --scenario batteries-included[/i]
    """
    extra_options = "--stop "
    if force:
        extra_options += "--force "
